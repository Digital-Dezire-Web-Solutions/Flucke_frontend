...
const NAV_ITEMS = [
    ...
    { label: "SHOP", path: "/shop", children: ["All Products", "Best Sellers", "New Arrivals"] },
                ...
                <nav className="rl-navbar__inner">
                    ...
                    <div className="rl-navbar__right-group">
                        ...
                        <div className="rl-navbar__icons">
                            ...
                            <button type="button" aria-label="Account" className="rl-navbar__icon-btn">
                                <UserIcon />
                            </button>
                            <button type="button" aria-label="Wishlist" className="rl-navbar__icon-btn">
                                <HeartIcon />
                            </button>
